...
ENGINE_MODELS = [
    ...
    "models/yolo26s-seg-fp32.engine",
    "models/yolo26s-seg-fp16.engine",
    "models/yolo26m-seg-fp32.engine",
    "models/yolo26m-seg-fp16.engine",
]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        default="reports/benchmark_report_engines",
