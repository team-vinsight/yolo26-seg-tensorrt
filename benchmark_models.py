...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pt", default="yolo26n-seg.pt", help="Path to .pt model")
    parser.add_argument("--onnx", default="yolo26n-seg.onnx", help="Path to .onnx model")
    parser.add_argument("--engine", default="yolo26n-seg.engine", help="Path to .engine model")
    parser.add_argument("--video", default="car.mp4", help="Video used to extract one benchmark frame")
